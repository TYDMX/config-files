...
function main(config) {
    ...
    config["proxy-groups"] = [
        ...
        ...创建地区分组("🇭🇰 香港", "Hong_Kong.png", 香港_List, `${香港正则}`, `${优选正则}`, `(?!.*${排除正则})`),
        ...创建地区分组("🇸🇬 狮城", "Singapore.png", 狮城_List, `${狮城正则}`, `${优选正则}`, `(?!.*${排除正则})`),
        ...创建地区分组("🇺🇸 美国", "United_States.png", 美国_List, `${美国正则}`, `${优选正则}`, `(?!.*${排除正则})`),
        ...创建地区分组("🇯🇵 日本", "Japan.png", 日本_List, `${日本正则}`, `${优选正则}`, `(?!.*${排除正则})`),
        ...创建地区分组("🇹🇼 台湾", "Taiwan.png", 台湾_List, `${台湾正则}`, `${优选正则}`, `(?!.*${排除正则})`),
        ...创建地区分组("🇰🇷 韩国", "Korea.png", 韩国_List, `${韩国正则}`, `${优选正则}`, `(?!.*${排除正则})`),
        ...创建地区分组("🇪🇺 欧盟", "European_Union.png", 欧盟_List, `${欧盟正则}`, `${优选正则}`, `(?!.*${排除正则})`),
    ];
