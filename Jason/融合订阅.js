...
function main(config) {
    ...
    const 阿里自建 = ["https://819431-jchlcf2024.alidns.com/dns-query#h3=true"];
    ...
    config["proxy-groups"] = [
        ...
        { name: "🇬 谷歌fcm", type: "select", proxies: ["🇨🇳 直连", "PASS-RULE"], icon: 图标库 + "Google_Search.png", hidden: false },
    ...
    config["rule-providers"] = {
        ...
        "openai":               { subRule:true, pre:[quicPre("")],
                                  group:"🤖 人工智能", target:"🤖 人工智能", ...domain_mrs, url:`${geosite_url}/openai.mrs` },
        ...
        "spotify":              { subRule:true, pre:[quicPre("")], target:"🎵 音乐服务", ...domain_mrs,     url:`${geosite_url}/spotify.mrs` },
        "paypal":               { subRule:true, pre:[quicPre("")], target:"💶 PayPal", ...domain_mrs,      url:`${geosite_url}/paypal.mrs` },
        "github":               { subRule:true, pre:[quicPre("")], target:"👨🏿‍💻 GitHub", ...domain_mrs,     url:`${geosite_url}/github.mrs` },
        "bing":                 { subRule:true, pre:[quicPre("")], target:"🪟 Bing", ...domain_mrs,        url:`${geosite_url}/bing.mrs` },
        "twitter":              { subRule:true, pre:[quicPre("")],
                                  group:"📲 社交媒体", target:"📲 社交媒体", ...domain_mrs, url:`${geosite_url}/twitter.mrs` },
        "tiktok":               { group:"📲 社交媒体", target:"📲 社交媒体", ...domain_mrs, url:`${geosite_url}/tiktok.mrs` },
        "reddit":               { group:"📲 社交媒体", target:"📲 社交媒体", ...domain_mrs, url:`${geosite_url}/reddit.mrs` },
        "discord":              { group:"📲 社交媒体", target:"📲 社交媒体", ...domain_mrs, url:`${geosite_url}/discord.mrs` },
        "vk":                   { group:"📲 社交媒体", target:"📲 社交媒体", ...domain_mrs, url:`${geosite_url}/vk.mrs` },
        ...
        "telegram":             { subRule:true, pre:[quicPre("")],
                                  group:"📲 电报飞机", target:"📲 电报飞机", ...domain_mrs, url:`${geosite_url}/telegram.mrs` },
        ...
        "cloudflare":           { subRule:true, pre:[quicPre("")],
                                  group:"🖥️ 代理服务", target:"🖥️ 代理服务", ...domain_mrs, url:`${geosite_url}/cloudflare.mrs` },
        ...
        "gfw":                  { subRule:true, pre:[quicPre("")],
                                  group:"🪜 代理域名", target:"🪜 代理域名", ...domain_mrs, url:`${geosite_url}/gfw.mrs` },
