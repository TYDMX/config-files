...
function main(config) {
    ...
    config["rule-providers"] = {
        ...
        //"google@cn":            { group:"🇬 谷歌@CN", target:"🇬 谷歌@CN", ...domain_mrs,    url:`${geosite_url}/google@cn.mrs`, "path-in-bundle":`${BundleMRS}/google@cn.mrs` },
        //"googlefcm":            { group:"🇬 谷歌@CN", target:"🇬 谷歌@CN", ...domain_mrs,    url:`${geosite_url}/googlefcm.mrs`, "path-in-bundle":`${BundleMRS}/googlefcm.mrs` },
